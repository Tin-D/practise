                ...
                power: {
                    ...
                    tooltip: {
                        ...
                        formatter: (params) => {
                            ...
                            let res = '<p>' + M + '月' + day + '日 ' + h + ':' + Min + ':' + s + '</p>';
                            for (let i = 0; i < params.length; i++) {
                                res += '<div><span class="circle" style="background:' + params[i].color + ';"></span>' + '<span>' + params[i].seriesName + ':' + params[i].data + ' ℃</span></div>';
                            }
                            return res;
                        },
                    },
                    legend: {
                        data: ['温度', '温度设定值', '温度读取值', '温度回风口实测值', '温度出风口实测值'],
                    },
                    toolbox: {
                        show: true,
                        feature: {
